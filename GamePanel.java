...
//         if (running) {
//             // // this command is used to Draw grids.
...
//                    // g.setColor(new Color(random.nextInt(255), random.nextInt(255), random.nextInt(255))); // use if you want a random color on skin of snake
//                     g.fillRect(x[i], y[i], UNIT_SIZE, UNIT_SIZE);
//                 }
//             }
//         g.setColor(Color.red);
